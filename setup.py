...
plugin_identifier = "afterreporttest"

# The plugin's python package, should be "octoprint_<plugin identifier>", has to be unique
plugin_package = "octoprint_afterreporttest"

# The plugin's human readable name. Can be overwritten within OctoPrint's internal data via __plugin_name__ in the
# plugin module
plugin_name = "OctoPrint-AfterReportTest"
...
# module
plugin_description = """A plugin to test the `octoprint.comm.protocol.firmware.after_report` hook."""
...
plugin_url = "https://github.com/kforth/OctoPrint-AfterReportTest"
